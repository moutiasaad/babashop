...
<html lang="fr" dir="ltr">
  <head>
    ...
    <title>ShaiebExpo - Connexion</title>
    ...
    <meta property="og:title" content="Application ShaiebExpo">
    ...
    <div class="login-wrap">
        <div class="login-area">
          <div class="login-main">
           <div class="login-logo"><h2 style="color:#B4442A;">ShaiebExpo</h2></div>
            ...
            <div id="step2" class="signup-block step ">
              <h3>Bienvenue,</h3>
              <p>Connexion au panneau d'administration ShaiebExpo</p>
