...
<head>
    ...
    <title>Shaieb Store - Ajouter une catégorie</title>
            ...
            <div class="container-fluid px-0">
                <form action="{{ route('admin.category.store') }}" method="POST" enctype='multipart/form-data'>
                    ...
                    <div class="main__header">
                        <div class="row">
                            <div class="col-6">
                                <h2 class="fs_24 text-black fw-bold fw-normal mb-0">Ajouter une nouvelle catégorie</h2>
                            </div>
                            <div class="col-6">
                                ...
                                <div class="row g_16">
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <input type="text" name="name" class="form-control inp_sm" placeholder="Ex: Électronique" value="{{ old('name') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div>
                                            <label class="form-label fs_14 c_dark2">Description</label>
                                            <textarea name="description" class="form-control inp_sm" rows="3" placeholder="Description de la catégorie...">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <div id="merchant_dropzone" class="dropzone_area">
                                                ...
                                                <p class="mb-0 fs_12">Cliquez ou glissez-déposez une image</p>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <input type="number" name="order_item" class="form-control inp_sm" value="{{ old('order_item') }}" placeholder="Ex: 1" min="1">
                                            <small class="text-muted">Laissez vide pour ajouter à la fin</small>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div>
