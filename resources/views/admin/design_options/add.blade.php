...
$Model_PLURAL = 'مزايا المنتج';
$Model_SINGULAR = 'مزايا المنتج';
$Model_API_ROUTE = 'design_options';
$Model_Name = 'design_options';
    ...
    <main class="main">
        <section class="mb_16">
            <div class="container-fluid px-0">
                <form action="{{ route('admin.' . $Model_API_ROUTE . '.store' , $id) }}" method="POST" enctype='multipart/form-data' >
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="d-flex justify-content-end">
                                    <div class="me-2">
                                        <a href="{{ url('dashboard/product/' . $id . '/edit') }}" class="btn btn_sm btn_primary_outline px-sm-4" type="reset">الغاء</a>
                                    </div>
                                    <div>
                                ...
                                <div class="row g_16">
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <input type="text" name="title" class="form-control inp_sm" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div>
                                            <label class="form-label fs_14 c_dark2"> النوع</label>
                                            <select name="type" class="form-control inp_sm">
                                                <option value="flower">نوع الزهور</option>
                                                <option value="card" >بطاقة إهداء</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <input type="text" name="price" value="0" class="form-control inp_sm" placeholder="" required>
                                        </div>
                                    </div>
