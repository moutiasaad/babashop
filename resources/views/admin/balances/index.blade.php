                                    ...
                                    <div class="col-md-7">
                                        <form action="#">
                                            ...
                                            <div class="dropdown d-inline-block ">
                                                <button class="btn btn_sm border rounded-pill" type="button">
                                                   <a href="/dashboard/settings/payments/transactions">    <i class="fi fi-rr-receipt"></i><span class="mx-2">عرض المعاملات</span></a>
                                                </button>
                                            </div>
                                        </form>
                                    </div>
...
<td>${(model.balance?.amount ?? 0).toFixed(2)} SAR</td>
                            <td>
                                <a href="/dashboard/{{ $Model_API_ROUTE }}/${model.id}/edit" class="btn btn_sm btn_primary">تحديث</a>
