                ...
                <div class="row g_24">
                    <div class="col-lg-6">
                        ...
                        <div class="bg-white rounded_16 p_24 mt-4">
                            <h3 class="fs_20 mb_16">أوقات التوصيل المتاحة</h3>
                                    ...
                                    <div class="row g_16 delivery-time-row">
                                        <div class="col-6">
                                            ...
                                            <input type="time" name="delivery_times[{{ $index }}][start]" 
                                                   ...
                                                   value="{{ old('delivery_times.' . $index . '.start') }}" 
                                                   required>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <input type="time" name="delivery_times[{{ $index }}][end]" 
                                                   class="form-control inp_sm"
                                                   value="{{ old('delivery_times.' . $index . '.end') }}" 
                                                   required>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="bg-white rounded_16 p_24">
                            ...
                            <div class="row g_16">
                                ...
                                <div class="col-12">
                                    <div>
                                        <label class="form-label fs_14 c_dark2">عنوان إيميل التنبيه</label>
