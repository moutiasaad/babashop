...
$Model_PLURAL = 'قوالب التنبيهات الألية';
$Model_SINGULAR = 'قوالب التنبيهات الألية';
$Model_API_ROUTE = 'notification_template';
    ...
    <main class="main">
        <section class="mb_16">
            <div class="container-fluid px-0">
                <form action="{{ route('admin.notification_template.update', $notification_template->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="main__header">
                        <div class="row">
                            <div class="col-6">
                                <h2 class="fs_24 text-black fw-bold fw-normal mb-0">تعديل التنبيه</h2>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="row g_24">
                        <div class="col-lg-12">
                            <div class="bg-white rounded_16 p_24">
                                <h3 class="fs_20 mb_16">تفاصيل التنبيه</h3>
                                <div class="row g_16">
                                    <div class="col-12">
                                        <div>
                                            <label class="form-label fs_14 c_dark2">العنوان</label>
                                            <input type="text" name="title" class="form-control inp_sm" value="{{ $notification_template->title }}" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div>
                                            <label class="form-label fs_14 c_dark2">الوصف</label>
                                            <textarea type="text" name="description" class="form-control inp_sm" >{{ $notification_template->description }}</textarea>
                                        </div>
                                    </div>
