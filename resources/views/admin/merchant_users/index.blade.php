...
<body>
        ...
        $(document).ready(function() {
            ...
            function renderTable(models) {
                ...
                if (models.length === 0) {
                    ...
                    tableBody.append(`
                        <tr>
                            <td colspan="8" class="text-center py-5">
                                ...
                                <p class="fs_18 text-gray">لا توجد حسابات لعرضها</p>
                            </td>
                        </tr>
                    `);
                } else {
                    ...
                    tableBody.append(`
                        <tr>
                            <td>${model.merchant ? model.merchant.brand_name : '(لا يوجد متجر)'}</td>
                            <td>${model.name}</td>
                            <td>${model.email}</td>
                            <td>${model.phone}</td>
                            <td>
                                <a href="/dashboard/merchant-users/${model.id}/edit" class="btn btn_sm btn_primary">تعديل</a>
    ...
    <script>
        function delete_product(productId) {
            ...
            window.location.href = '/dashboard/merchant-users/' + productId + '/delete';
        }
    </script>
