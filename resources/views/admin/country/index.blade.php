...
<head>
    ...
    <title>{{ env('APP_NAME') }} - البلدان</title>
...
<body>
                ...
                <div class="modal-body p-3">
                    ...
                    <div>
                        <div class="d-flex justify-content-center">
                            <div>
                                <button class="btn btn_sm btn_primary alert__submitBtn" type="submit" aria-label="Close">نعم، تأكيد</button>
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="bg-white rounded_16 pb_12">
                            ...
                            <div class="border-bottom py_12 px_16">
                                <div class="row align-items-center gy_16">
                                    <div class="col-md-5">
                                        <h2 class="fs_18 fw-normal mb-0">البلدان</h2>
                                            ...
                                            <div class="text-end d-flex justify-content-end">
                                                <div class="flex-grow-1">
                                                    <div class="input-group search_inpGrp border rounded-pill fs_sm overflow-hidden pr_xsm2 ms-auto">
                                                        ...
                                                        <input class="form-control inp_sm border-0 shadow-none" type="search" id="search" placeholder="البحث">
                                                    </div>
                                                </div>
                                                <div class="dropdown filter_dropdown d-inline-block mr_8">
                                                    <a class="btn btn_sm border rounded-pill" href="{{ route('admin.country.add') }}">
        ...
        $(document).ready(function() {
            function fetch_data(page = 1, query = '', perPage = 10) {
                $.ajax({
                    ...
                    method: 'GET',
                    data: { page: page, search: query, per_page: perPage },
                    success: function(response) {
                        renderTable(response.countries);
                    ...
                    countries.forEach(country => {
                        tableBody.append(`
                            <tr>
                                ...
                                <td class="text-end">
                                    <button class="btn pdt_actBtn" onclick="showDeleteModal(${country.id})"><i class="fi fi-rr-trash"></i></button>
                                </td>
                            </tr>
                        `);
                    });
            ...
            function renderPagination(pagination) {
                ...
                if (pagination.prev_page_url) {
                    paginationLinks.append(`<li class="page-item"><a class="page-link" href="#" data-page="${pagination.current_page - 1}">Previous</a></li>`);
                }
    
                for (let i = 1; i <= pagination.last_page; i++) {
                    paginationLinks.append(`<li class="page-item ${pagination.current_page == i ? 'active' : ''}"><a class="page-link" href="#" data-page="${i}">${i}</a></li>`);
                }
    
                if (pagination.next_page_url) {
                    paginationLinks.append(`<li class="page-item"><a class="page-link" href="#" data-page="${pagination.current_page + 1}">Next</a></li>`);
                }
            }
    ...
    function delete_product(productId) {
        ...
        window.location.href = '/dashboard/country/' + productId + '/delete';
    }
