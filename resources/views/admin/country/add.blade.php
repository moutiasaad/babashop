...
<head>
    ...
    <title>{{ env('APP_NAME') }} - المدن</title>
            ...
            <div class="container-fluid px-0">
                <form action="{{ route('admin.country.store') }}" method="POST">
                    ...
                    <div class="main__header">
                        <div class="row">
                            <div class="col-6">
                                <h2 class="fs_24 text-black fw-bold fw-normal mb-0">إضافة مدينة جديد</h2>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="row g_24">
                        <div class="col-lg-12">
                            <div class="bg-white rounded_16 p_24">
                                <h3 class="fs_20 mb_16">تفاصيل المدينة</h3>
                                <div class="row g_16">
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <!-- Error message in case of validation failure -->                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
