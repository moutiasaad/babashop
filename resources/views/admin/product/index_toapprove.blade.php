...
<body>
                        ...
                        <div class="bg-white rounded_16 pb_12">
                            ...
                            <div class="border-bottom py_12 px_16">
                                <div class="row align-items-center gy_16">
                                    <div class="col-md-5">
                                        <h2 class="fs_18 fw-normal mb-0">المنتجات بإنتضار المراجعة</h2>
    ...
    <script>
        ...
        function showApprouveModal(productId) {
            productIdToDelete = productId;
            $('#alert__modal').modal('show');
            $('.alert__title').text('هل أنت متأكد أنك تريد الموافقة على المنتج ؟');
            $('.alert__desc').text('سيتم الموافقة على المنتج و عرضه في المتجر ');
        }
        ...
        $('.alert__submitBtn').on('click', function() {
            approve_product(productIdToDelete);
        });
    </script>
    ...
    <tr>
        ...
        <td>
            <a  onclick="showApprouveModal(${model.id}, ${model.visibility})" class="btn btn_sm btn_primary">الموافقة</a>
        <a 
            class="btn btn_sm btn_danger" 
            href="/dashboard/{{ $Model_API_ROUTE }}/${model.id}/edit">
            التعديل
        </a>
                <button 
            class="btn btn_sm btn_danger" 
...
`);
    ...
    <script>
        ...
        function approve_product(productId) {
            // Redirect to the delete route
            window.location.href = '/dashboard/{{ $Model_API_ROUTE }}/' + productId + '/ApproveProduct';
        }
    </script>
