...
$Model_PLURAL = 'أقسام المتاجر';
$Model_SINGULAR = 'قسم المتاجر';
$Model_API_ROUTE = 'merchant_categorie';
$Model_Name = 'MerchantCategorie';
    ...
    <main class="main">
        <section class="mb_16">
            <div class="container-fluid px-0">
                <form action="{{ route('admin.merchant_categorie.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="main__header">
                        <div class="row">
                            <div class="col-6">
                                <h2 class="fs_24 text-black fw-bold fw-normal mb-0">تعديل قسم المتاجر</h2>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="row g_24">
                        <div class="col-lg-12">
                            <div class="bg-white rounded_16 p_24">
                                <h3 class="fs_20 mb_16">تفاصيل قسم المتاجر</h3>
                                <div class="row g_16">
                                    <div class="col-12">
                                        <div>
