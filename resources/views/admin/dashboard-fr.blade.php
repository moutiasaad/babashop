...
<head>
    ...
    <title>Shaieb Store - Tableau de bord</title>
                ...
                <div class="modal-body p-3">
                    ...
                    <div>
                        <div class="d-flex justify-content-center">
                            <div>
                                <button class="btn btn_sm btn_primary alert__submitBtn" type="submit"  data-bs-dismiss="modal" aria-label="Close">Oui, confirmer</button>
                            </div>
                            <div class="ms-2">
            ...
            <div class="container-fluid px-0">
                <div class="row g_24">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="chart_card">
                            <div class="chart_header">
                                ...
                                <div class="chart_info">
                                    <div class="chart_title">Total des transactions</div>
                                    <div class="chart_value">{{ number_format($totalSales ?? 0, 2) }} TND</div>
                                </div>
                                <div class="chart_extraInfo c_success">
                                    +{{ number_format($dailyProfits ?? 0, 2) }} TND aujourd'hui
                                </div>
                            </div>
                            <div class="chart_wrapper">
                    ...
                    <div class="col-md-6 col-lg-7">
                        <div class="bg-white rounded_16 h-100 d-flex flex-column">
                            <div class="border-bottom py_12 px_16">
                                <h2 class="fs_18 fw-normal mb-0">Nombre de ventes / mois</h2>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-5">
                        <div class="bg-white rounded_16 h-100 d-flex flex-column">
                            <div class="border-bottom py_12 px_16">
                                <h2 class="fs_18 fw-normal mb-0">Statistiques</h2>
                            </div>
                            <div class="p_12 pt-1 flex-grow-1">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if ($("#statistics_chart").length > 0) {
            var statistics_chart = new ApexCharts(document.querySelector("#statistics_chart"), {
                ...
                labels: ["Terminées", "En cours", "Annulées"],
                chart: {
                    type: "donut",
                    height: "400px",
                },
