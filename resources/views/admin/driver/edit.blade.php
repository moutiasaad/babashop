...
$Model_PLURAL = 'مندوب التوصيل';
$Model_SINGULAR = 'مناديب التوصيل';
    ...
    <main class="main">
        <section class="mb_16">
            <div class="container-fluid px-0">
                <form action="{{ route('admin.driver.update', $dedication->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="main__header">
                        <div class="row">
                            <div class="col-6">
                                <h2 class="fs_24 text-black fw-bold fw-normal mb-0">تعديل مندوب التوصيل</h2>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="row g_24">
                        <div class="col-lg-12">
                            <div class="bg-white rounded_16 p_24">
                                <h3 class="fs_20 mb_16">تفاصيل مندوب التوصيل</h3>
                                <div class="row g_16">
                                    <div class="col-12">
                                        <div>
                                    ...
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <input type="text" name="phone" class="form-control inp_sm" value="{{ $dedication->phone }}" required>
                                        </div>
                                    </div>
