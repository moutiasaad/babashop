...
<head>
    ...
    <title>Shaieb Store - Ajouter une bannière</title>
            ...
            <div class="container-fluid px-0">
                <form action="{{ route('admin.banner.store') }}" method="POST" enctype='multipart/form-data'>
                    ...
                    <div class="main__header">
                        <div class="row">
                            <div class="col-6">
                                <h2 class="fs_24 text-black fw-bold fw-normal mb-0">Ajouter une nouvelle bannière</h2>
                            </div>
                            <div class="col-6">
                                ...
                                <div class="row g_16">
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <input type="text" name="name" class="form-control inp_sm" placeholder="Ex: Bannière Promo Été" value="{{ old('name') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div>
                                            <label class="form-label fs_14 c_dark2">Lien (optionnel)</label>
                                            <input type="text" name="link" class="form-control inp_sm" placeholder="Ex: /products/promo-summer" value="{{ old('link') }}">
