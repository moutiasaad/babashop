...
$Model_SINGULAR = 'المنطقة';
$Model_API_ROUTE = 'regions';
                    ...
                    models.forEach(model => {
                        ...
                        tableBody.append(`
                            <tr>
                                ...
                                <td class="text-end">
                                    <button class="btn pdt_actBtn" onclick="showDeleteModal(${model.id})"><i class="fi fi-rr-trash"></i></button>
                                </td>
                            </tr>
                        `);
                    });
