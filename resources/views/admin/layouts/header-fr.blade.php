        ...
        <div class="col-2 col-sm-2 col-md-3 col-xl-4">
            <div class="d-flex">
                ...
                <div class="d-none d-xl-block">
                    <div class="fs_20 c_dark3">Bienvenue {{ auth()->guard('admin')->user()->name." ".auth()->guard('admin')->user()->title}}</div>
            ...
            <div class="text-end">
                ...
                <div class="dropdown userOpts_dropdown d-inline-block mr_8">
                    <button class="btn btn_sm" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="userOpts_pflImg" src="{{ '/admin/img/person.svg' }}" alt="profile"><span class="d-lg-inline ps-1">{{auth()->guard('admin')->user()->name}} ({{auth()->guard('admin')->user()->title}}) <i class="fi fi-rr-angle-small-down lh-1"></i></span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end rounded_16 border p_6 fs_16">
                        <li><a class="dropdown-item rounded_12" href="/dashboard/profileSet"><i class="fi fi-rr-user me-2"></i> Paramètres du compte</a></li>
                        <li><a class="dropdown-item rounded_12" href="/logout"><i class="fi fi-rr-arrow-circle-right me-2"></i> Déconnexion</a></li>
                    </div>
                </div>
            </div>
        </div>
