...
$Model_PLURAL = 'تفاصيل التصميم';
$Model_SINGULAR = 'تفاصيل التصميم';
$Model_API_ROUTE = 'design_attributes';
$Model_Name = 'design_attributes';
            ...
            <div class="row g_16">
                <div class="col-12">
                    <div>
                        ...
                        <input type="text" id="title_input" name="title" class="form-control inp_sm" placeholder="">
                        <input type="color" id="color_input" name="title_color" class="form-control inp_sm" style="display: none;">
                    </div>
                </div>
                <div class="col-12">
                    <div>
                        <label class="form-label fs_14 c_dark2"> النوع</label>
                        <select id="type_select" name="type" class="form-control inp_sm">
                          <option value="tape">خامة الشريط</option>
                            <option value="cover">خامة الغلاف</option>
                            <option value="color_tape">لون الشريط</option>
                            <option value="color_cover">لون الغلاف</option>
                        </select>
                    </div>
                </div>
                <div class="col-12" id="image_section">
                <div>
...
<script>
    document.getElementById('type_select').addEventListener('change', function () {
        ...
        if (type === 'color_tape' || type === 'color_cover') {
